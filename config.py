...
class Settings(BaseSettings):
    # Rutas de tus datos
    NDJSON_PATH: str = "/home/ubuntu/asphyxia-core/savedata/ddr@mdx.db"
    SONGS_DICT_PATH: str = "/home/ubuntu/scoreboard/songs.json"

    # CORS (frontend)
    CORS_ORIGINS: list[str] = ["http://ec2-18-189-184-3.us-east-2.compute.amazonaws.com", "http://localhost:5173", "http://127.0.0.1:5173"]
